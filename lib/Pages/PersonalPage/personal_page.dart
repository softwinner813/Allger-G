...
class _PersonalPageState extends State<PersonalPage> {
  ...
  Future<void> updateData() async {
    ...
    try {
      ...
      _userModel.ePhoneNubmer = ephoneCtl.text;
      _userModel.contacts = _contactList;
                                  ...
                                  onPressed: () async {
                                    ...
                                    _selectedContacts.forEach((element) {
                                      ContactModel cmodel = ContactModel(
                                        ...
                                        phoneNumber: element.phones!.isNotEmpty
                                            ? element.phones![0].value!
                                            : LocaleKeys.contactsPage_nonumber
                                                .tr(),
                                      );
                                      setState(() {
                                        _contactList.add(cmodel);
                                      });
                                    });
                                    // _selectedContacts.forEach((element) {
                                    //   ContactModel cmodel = ContactModel(
